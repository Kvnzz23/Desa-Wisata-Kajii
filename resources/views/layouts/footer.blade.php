<div class="container text-white">
    <div class="footer-left">
        ...
        <div class="media-sosial">
            <a href="https://www.instagram.com/dewikajii/?hl=id" target="_blank" class="ikon instagram">
            ...
            <a href="https://www.facebook.com/dewikajii?locale=id_ID" target="_blank" class="ikon facebook">
            ...
            <a href="https://www.youtube.com/@desawisatakajii3570" target="_blank" class="ikon youtube">
    ...
    <div class="footer-center">
        ...
        <div class="email">
            <h3>dewikajiikadisoro@gmail.com</h3>
        </div>
        <div class="nomer">
            <h3>+62 858-1106-2212</h3>
            <p> ( MUH. GEMA RAMADHAN ) </p>
        </div>
    </div>
    <div class="footer-right">
        ...
        <div class="alamat">
            <h3>Dusun Kajii, Kadisoro, Gilangharjo, Kec. Pandak, Kab. Bantul, Daerah Istimewa Yogyakarta 55761</h3>
        </div>
    </div>
</div>
<div class="copyright text-white text-center">
    Copyright © 2024 Desa Wisata Kajii
</div>